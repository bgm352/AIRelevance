...
def main():
    ...
    st.markdown("""
        **Workflow:**
        1. Enter your target query and upload a CSV of ranking URLs.
        2. Extract and score passages from your and competitors' pages.
        3. Use AI to rewrite your passages for better relevance.
    """)
